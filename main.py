...
class Solution:
    ...
    def convertBST(self, root: Optional[TreeNode]) -> Optional[TreeNode]:
        def transverseBST(root: TreeNode | None) -> Iterator[TreeNode | None]:
            none_root = root is not None
            if none_root: yield from transverseBST(root.right)
            yield root
            if none_root: yield from transverseBST(root.left)
    ...
    # 1338. Reduce Array Size to The Half #unfinished
    ...
    def romanToInt(self, s: str) -> int:
        ...
        for i in s[1:]:
            ...
            if values[i] > values[last]:
                ret -= (values[last] * 2) #*2 because the last one was summed too
            last = i
        return ret
...
if __name__ == "__main__":
    ...
    print(a.minSetSize(
        [2, 28, 92, 30, 100, 52, 28, 48, 91, 27, 66, 19, 11, 53, 91, 95, 74, 51, 65, 65, 96, 81, 21, 55, 98, 3, 2, 89,
         99, 57, 78, 34, 50, 2, 57, 76, 23, 90, 89, 36, 53, 22, 73, 59, 95, 45]))
    print(14)
    """
